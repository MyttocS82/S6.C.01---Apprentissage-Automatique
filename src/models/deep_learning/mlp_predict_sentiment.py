...
def train_mlp_sentiment(print_eval: bool = False):
    ...
    model.save(MODELS_FOLDER / "model_mlp_sentiment.keras")

    if print_eval:
        print("\nMLP sentiment predictions :")
        model.evaluate(X_test, y_test)


if __name__ == "__main__":
    train_mlp_sentiment(print_eval=False)
